...
public class SchoolDocumentRequestResponse implements Serializable {
	...
	private String schoolDocumentStatus;
	...
	public String getSchoolDocumentStatus() {
		return schoolDocumentStatus;
	}

	public void setSchoolDocumentStatus(String schoolDocumentStatus) {
		this.schoolDocumentStatus = schoolDocumentStatus;
	}
